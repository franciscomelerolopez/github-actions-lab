...
5. Comentario adicional
   ...
   Posteriormente lo realizo sobre sobre docker registry en otro fichero que se llama cd-registry.yml (lo he ejecutado en master sin darme cuenta) directamente ahí.
